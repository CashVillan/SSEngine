...
public class GunData {
	...
	public static HashMap<Player, ItemStack> reloading = new HashMap<Player, ItemStack>();
	...
	public static boolean containsAmmo(Ammo ammo) {
		boolean contains = false;
		
		for(Ammo all : allAmmo) {
			if(all.getName().equals(ammo.getName())) {
				contains = true;
			}
		}
		return contains;
